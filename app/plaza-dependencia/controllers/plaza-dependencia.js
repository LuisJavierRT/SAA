(function(){
	...
	angular
		.module('saaApp')
	    .controller('PlazaDependenciaCtrl', ['$q' ,'$scope', '$state','PlazaService', 'DependenciaService', 'shareSessionService','messageHandlerService', 
	    function($q, $scope, $state, plazaService, dependenciaService, shareSessionService, messageHandlerService) {
